...
namespace LinkConverter.Tests.Tests.DeepLinkToWebUrl
{
    ...
    public class HomeTest
    {
        ...
        public static IEnumerable<object[]> Home_Success_Data()
            => Helper.TestDataReaderHelper.GetAppsettingsTestData<ConvertModel>("DeepLinkToWebUrl.TestData.Home_Success_Data.json");
        ...
        public static IEnumerable<object[]> Home_Success_Fail_Data()
            => Helper.TestDataReaderHelper.GetAppsettingsTestData<ConvertModel>("DeepLinkToWebUrl.TestData.Home_Success_Fail.json");
